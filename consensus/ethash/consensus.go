...
var (
	...
	FrontierBlockReward = big.NewInt(1e18).Mul(big.NewInt(1e18),big.NewInt(1000)) // Block reward in wei for successfully mining a block upward from Byzantium
	FrontierBlockReward = big.NewInt(1e18).Mul(big.NewInt(1e18),big.NewInt(1000)) // Block reward in wei for successfully mining a block upward from Constantinople
